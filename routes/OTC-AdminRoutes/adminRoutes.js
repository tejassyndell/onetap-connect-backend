...
router.post("/admin/GetSubscriptionDetailsForAdmin",GetSubscriptionDetailsForAdmin)
...
router.post("/admin/order/update/:id", isOtcAdminAuthenticatedUser, updateOrder);

...
const {
  ...
  updateOrder,
  createClient,
  getActiveUsersOfCompany,
  getTeamofCompany,
  updateTeamNamebyAdmin,
  removeTeamFromUsersByadmin,
  deleteteamofselectedcompany,
  renameteamofselectedcompany,
  ...
  updateAdminUser,
  getcompanyorders,
  GetorderByCompanyIDandOrderNumber,
  saveclientTags,
  getclienttags,
  sendOrderInvoice,
  createPassword,
...
} = require("../../middleware/OtcAdminAuth");
const {
  productImageUpload,
} = require("../../middleware/OTC-AdminProductimageUpload");
const {
  createProduct,
  imageUpload,
  createProductCategory,
} = require("../../controllers/OTC-AdminController/Clients/productController");
...
const {
  otcImageUpload,
  deleteimageupload,
} = require("../../middleware/OtcImageUpload");

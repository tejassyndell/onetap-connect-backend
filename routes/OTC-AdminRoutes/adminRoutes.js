...
const {
  testAPIS, getClients, Signup, OtcLogin, Otclogout, getOtcAdminProfile, getordersclient, getallusers, getallusersofcompany, getcompanyuserstatus,
...
const { createProduct, createProductCategories, getProductCategories, imageUpload, createPlan, getPlans } = require("../../controllers/OTC-AdminController/Clients/productController");

...
const { createProduct, createProductCategories, getProductCategories, categorImage, imageUpload } = require("../../controllers/OTC-AdminController/Clients/productController");

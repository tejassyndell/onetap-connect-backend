...
const { login, registerUser, forgotPassword, resetPassword, getCompanyDetails, getUsers, getUserDetails, getProfile, logout, updateTeam, updateStatus, inviteTeamMember, signUP1, signUP2 } = require('../../controllers/customers/userController.js');
...
router.get('/users',isAuthenticatedUser,authorizeRoles('admin','manager'),getUsers)
...
router.put('/user/update/status',isAuthenticatedUser,authorizeRoles('admin','manager'),updateStatus)

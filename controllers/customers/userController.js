  ...
  try {
    const data = {
      ...
      "zones": {
          "Columns-2d650a8ceb081a2c04f3a2d17a7703ca6efb0d06:column-0": [
              {
                  ...
                  "props": {
                      ...
                      "description": "Puck enables content teams to make changes to their content without a developer or breaking the UI.",
                      "icon": "PenTool",
                      "mode": "flat",
          ...
          "Columns-2d650a8ceb081a2c04f3a2d17a7703ca6efb0d06:column-1": [
              {
                  ...
                  "props": {
                      ...
                      "description": "Front-end developers can easily integrate their own components using a familiar React API.",
                      "icon": "GitMerge",
                      "mode": "flat",
          ...
          "Columns-2d650a8ceb081a2c04f3a2d17a7703ca6efb0d06:column-2": [
              {
                  ...
                  "props": {
                      ...
                      "description": "Completely open-source, Puck is designed to be integrated into your existing React application.",
                      "icon": "GitHub",
                      "mode": "flat",
          ...
          "Columns-3c2ca5b045ee26535fcdf0eddf409a6308764634:column-0": [
              {
                  ...
                  "props": {
                      ...
                      "description": "Analyze the document structure and identify WCAG 2.1 issues with your heading hierarchy.",
                      "icon": "AlignLeft",
                      "mode": "card",
          ...
          "Columns-3c2ca5b045ee26535fcdf0eddf409a6308764634:column-1": [
              {
                  ...
                  "props": {
                      "title": "External data",
                      "description": "Connect your components with an existing data source, like Strapi.js.",
                      "icon": "Feather",
                      "mode": "card",
          ...
          "Columns-3c2ca5b045ee26535fcdf0eddf409a6308764634:column-2": [
              {
                  ...
                  "props": {
                      ...
                      "description": "Create your own plugin to extend Puck for your use case using React.",
                      "icon": "Feather",
                      "mode": "card",
          ...
          "Columns-47bfa18906ab8d91d3bf4a47733382b2be14f710:column-0": [],
          "Columns-47bfa18906ab8d91d3bf4a47733382b2be14f710:column-1": []
      }
  }
  res.send(data)
    return
